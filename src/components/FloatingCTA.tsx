    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 md:hidden shadow-[0_-4px_20px_rgba(0,0,0,0.1)] pb-safe">
      <div className="flex gap-[6px] px-3 py-[10px]">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.96 }}
          className="flex-[2] bg-[#06C755] text-white rounded-[10px] flex flex-col items-center justify-center py-2 px-1 shadow-sm"
        >
          <div className="flex items-center gap-1.5 mb-0.5">
            ...
            <span className="font-bold text-[13px] sm:text-[14px]">LINEで無料相談</span>
          </div>
        </motion.a>
        ...
        <motion.button
          ...
          className="flex-[1] bg-white text-slate-700 border border-slate-300 rounded-[10px] flex flex-col items-center justify-center py-2 px-1 shadow-sm"
        >
          <div className="flex items-center gap-1.5">
            <Mail className="w-4 h-4" />
            <span className="font-bold text-[12px] sm:text-[13px]">フォーム</span>
          </div>
        </motion.button>
      </div>
    </div>
