...
const services = [
  {
    ...
    subtitle: '',
    description: '「利益は出ているのに現金がない」「月次の数字を経営判断に使えていない」。M&A投資先に常駐し、ゼロから管理会計を立ち上げてきた経験をもとに、御社の社外CFOとして経営管理体制の構築を伴走します。壁打ち相手としてだけでなく、決算書を「意思決定のツール」に変えるところまで、一緒に手を動かします。',
    list: [
